<?php
/**
 * Copyright © 2015 Ihor Vansach (ihor@risecommerce.com). All rights reserved.
 ...
 */
class PostList extends \Risecommerce\Blog\Block\Post\PostList\AbstractList implements \Magento\Widget\Block\BlockInterface
{
    /**
     * Block template file
     * @var string
     */
	protected $_defaultToolbarBlock = 'Risecommerce\Blog\Block\Post\PostList\Toolbar';
	...
	public function getTemplate()
    {
        if ($this->isFullHtml()) {
            ...
            return 'Risecommerce_Blog::post/widget/ajax-blog.phtml';
        }
    }
