...
namespace Risecommerce\Blog\Block\Post\PostList\Toolbar;

use Risecommerce\Blog\Model\Config\Source\LazyLoad;
...
class Pager extends \Magento\Theme\Block\Html\Pager
{
    ...
    public function getLazyloadMode()
    {
        return (int) $this->_scopeConfig->getValue(
            'rcblog/post_list/lazyload_enabled',
    ...
    {
        return (int) $this->_scopeConfig->getValue(
            'rcblog/post_list/lazyload_padding',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
}
