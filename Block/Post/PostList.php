 ...
 */
class PostList extends \Risecommerce\Blog\Block\Post\PostList\AbstractList
{
    /**
     * Block template file
     * @var string
     */
    protected $_defaultToolbarBlock = \Risecommerce\Blog\Block\Post\PostList\Toolbar::class;
    ...
    protected function _prepareLayout()
    {
        $page = (int)$this->_request->getParam(
            \Risecommerce\Blog\Block\Post\PostList\Toolbar::PAGE_PARM_NAME
        );
