...
class RelatedProducts extends AbstractProduct implements IdentityInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $this->_itemCollection->setPageSize(
            (int) $this->_scopeConfig->getValue(
                \Risecommerce\Blog\Model\Config::XML_RELATED_PRODUCTS_NUMBER,
        ...
        $this->_eventManager->dispatch('rcblog_relatedproducts_block_load_collection_before', [
            'block' => $this,
    ...
    public function displayProducts()
    {
        return (bool) $this->_scopeConfig->getValue(
            \Risecommerce\Blog\Model\Config::XML_RELATED_PRODUCTS_ENABLED,
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
