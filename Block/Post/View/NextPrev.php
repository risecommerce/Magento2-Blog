...
class NextPrev extends \Magento\Framework\View\Element\Template
{
     ...
     * @param \Risecommerce\Blog\Model\ResourceModel\Post\CollectionFactory $_tagCollectionFactory
    ...
    public function displayLinks()
    {
        return (bool)$this->_scopeConfig->getValue(
            'rcblog/post_view/nextprev/enabled',
    ...
    public function getTemplate()
    {
        $templateName = (string)$this->_scopeConfig->getValue(
            'rcblog/post_view/nextprev/template',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
