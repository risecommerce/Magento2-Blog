...
/**
 * Blog post Risecommerce comments block
 */
class Risecommerce extends \Risecommerce\Blog\Block\Post\View\Comments implements \Magento\Framework\DataObject\IdentityInterface
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    protected $defaultCommentBlock = \Risecommerce\Blog\Block\Post\View\Comments\Risecommerce\Comment::class;
     ...
     *
     * @return \Risecommerce\Blog\Block\Post\View\Comments\Risecommerce\Comment
     */
     ...
     * @return string
     */
    public function getCommentHtml(\Risecommerce\Blog\Model\Comment $comment)
    {
    ...
    public function canPost()
    {
        return $this->_scopeConfig->getValue(
            \Risecommerce\Blog\Model\Config::GUEST_COMMENT,
    ...
    {
        return $this->_scopeConfig->getValue(
            \Risecommerce\Blog\Model\Config::NUMBER_OF_COMMENTS,
            ScopeInterface::SCOPE_STORE
        );
    }
