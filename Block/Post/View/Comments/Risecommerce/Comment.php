...
namespace Risecommerce\Blog\Block\Post\View\Comments\Risecommerce;
...
/**
 * Risecommerce comment block
 *
 * @method string getComment()
 * @method $this setComment(\Risecommerce\Blog\Model\Comment $comment)
 */
class Comment extends Template implements IdentityInterface
{
     ...
     * @var string
     */
    protected $_template = 'Risecommerce_Blog::post/view/comments/risecommerce/comment.phtml';
     ...
     *
     * @return \Risecommerce\Blog\Model\ResourceModel\Comment\Collection | array
     */
    ...
    public function getNumberOfReplies()
    {
        return $this->_scopeConfig->getValue(
            \Risecommerce\Blog\Model\Config::NUMBER_OF_REPLIES,
    ...
    public function getPublishDate()
    {
        $dateFormat = $this->_scopeConfig->getValue(
            'rcblog/post_view/comments/format_date',
