...
class Comments extends \Magento\Framework\View\Element\Template
{
    ...
    {
        return $this->_scopeConfig->getValue(
            'rcblog/post_view/comments/display_privacy_policy_checkbox',
            ScopeInterface::SCOPE_STORE
        );
    }
    ...
    public function getNumberOfComments()
    {
        return (int)$this->_scopeConfig->getValue(
            'rcblog/post_view/comments/number_of_comments',
            ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->_scopeConfig->getValue(
            'rcblog/post_view/comments/fb_app_id',
            ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->_scopeConfig->getValue(
            'rcblog/post_view/comments/disqus_forum_shortname',
            ScopeInterface::SCOPE_STORE
        );
    }
