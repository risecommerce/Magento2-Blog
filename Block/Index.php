 ...
 * Blog index block
 */
class Index extends \Risecommerce\Blog\Block\Post\PostList
{
    /**
    ...
    protected function _prepareLayout()
    {
        ...
        if ($this->config->getDisplayCanonicalTag(\Risecommerce\Blog\Model\Config::CANONICAL_PAGE_TYPE_INDEX)) {
    ...
    public function getToolbarBlock()
    {
        ...
        $limit = (int)$this->_scopeConfig->getValue(
            'rcblog/index_page/posts_per_page',
    ...
    protected function _preparePostCollection()
    {
        ...
        $displayMode = $this->_scopeConfig->getValue(
            \Risecommerce\Blog\Model\Config::XML_PATH_HOMEPAGE_DISPLAY_MODE,
            ScopeInterface::SCOPE_STORE
        );
        /* If featured posts enabled */
        if ($displayMode == 1) {
            $postIds = $this->_scopeConfig->getValue(
                \Risecommerce\Blog\Model\Config::XML_PATH_HOMEPAGE_FEATURED_POST_IDS,
                ScopeInterface::SCOPE_STORE
            );
    ...
    public function getCollectionOrderField()
    {
        $postsSortBy = $this->_scopeConfig->getValue(
            \Risecommerce\Blog\Model\Config::XML_PATH_HOMEPAGE_POSTS_SORT_BY,
            ScopeInterface::SCOPE_STORE
        );
