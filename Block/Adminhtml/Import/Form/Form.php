...
namespace Risecommerce\Blog\Block\Adminhtml\Import\Form;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'after_element_html' => 'When the import is completed successfully,
                                        ...
                                        <strong style="color:#105610;">pub/media/risecommerce_blog</strong>
                                        directory.',
            ]
        );
        ...
        $this->_eventManager->dispatch('risecommerce_blog_import_' . $type . '_prepare_form', ['form' => $form]);
