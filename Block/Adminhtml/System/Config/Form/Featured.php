        ...
        return "require([
                 ...
                 'Magento_Ui/js/modal/modal'
                        ...
                        $(document).ready(function(){
                            /*document.getElementById('rcblog_sidebar_featured_posts_posts_ids').setAttribute('readonly', true);*/
                            ...
                            $('#rcblog_sidebar_featured_posts_posts_ids').dblclick(function() { 
                                window.reload = true;
                                postStateStr = $('#rcblog_sidebar_featured_posts_posts_ids').val();
                                        ...
                                        buttons: [{
                                            ...
                                            click: function () {
                                                        ...
                                                        if (window.postState.length) {
                                                            $('#rcblog_sidebar_featured_posts_posts_ids').val(window.postState.join(','));
                                                        }
                                                        else {
                                                            $('#rcblog_sidebar_featured_posts_posts_ids').val('');
                                                        }
                                                        this.closeModal();
                                                  }
                                        }]
                                ...
                                $('#post_ids .admin__data-grid-wrap.admin__data-grid-wrap-static > table > tbody > tr').each(function () {
                                    ...
                                    var isChoosed = $('#rcblog_sidebar_featured_posts_posts_ids').val().includes(postId);
