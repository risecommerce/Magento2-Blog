 ...
 * Blog category view
 */
class View extends \Risecommerce\Blog\Block\Post\PostList
{
    /**
    ...
    protected function _prepareLayout()
    {
        ...
        if ($category) {
            ...
            if ($this->config->getDisplayCanonicalTag(\Risecommerce\Blog\Model\Config::CANONICAL_PAGE_TYPE_CATEGORY)) {
