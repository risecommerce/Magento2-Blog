<?php
/**
 * Copyright © 2016-Risecommerce (support@risecommerce.com). All rights reserved.
 * 
 *
 ...
 */
class SubCategoryLinks extends \Risecommerce\Blog\Block\Category\AbstractCategory
{
