...
namespace Risecommerce\Blog\Controller\Adminhtml\Import;
...
class Form extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        try {
            ...
            $this->_setActiveMenu('Risecommerce_Blog::import');
    ...
    {
        return $this->_authorization->isAllowed('Risecommerce_Blog::import');
    }
    ...
    {
        if (null === $this->config) {
            $this->config = $this->_objectManager->get(\Risecommerce\Blog\Model\Config::class);
        }
