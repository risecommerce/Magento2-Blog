 ...
 */
class Save extends \Risecommerce\Blog\Controller\Adminhtml\Post
{
    /**
     * @var string
     */
    protected $_allowedKey = 'Risecommerce_Blog::post_save';

    /**
     * Before model save
     * @param  \Risecommerce\Blog\Model\Post $model
    ...
    protected function _beforeSave($model, $request)
    {
                ...
                if (!empty($data[$key]['delete'])) {
                    ...
                    if (isset($data[$key][0]['name']) && isset($data[$key][0]['tmp_name'])) {
                        ...
                        $imageUploader = $this->_objectManager->get(
                            \Risecommerce\Blog\ImageUpload::class
                        );
        ...
        if ($tagInput) {
            ...
            $tagsCollection = $this->_objectManager->create(\Risecommerce\Blog\Model\ResourceModel\Tag\Collection::class);
            $allTags = [];
            ...
            foreach ($tagInput as $tagTitle) {
                ...
                if (empty($allTags[$tagTitle])) {
                    $tagModel = $this->_objectManager->create(\Risecommerce\Blog\Model\Tag::class);
