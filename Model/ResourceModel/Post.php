...
class Post extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('risecommerce_blog_post', 'post_id');
    }
    ...
    protected function _beforeDelete(
        ...
        foreach ($tableSufixs as $sufix) {
            $this->getConnection()->delete(
                $this->getTable('risecommerce_blog_post_' . $sufix),
                ($sufix == 'relatedpost')
    ...
    protected function _beforeSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $identifierGenerator = \Magento\Framework\App\ObjectManager::getInstance()
                ->create(\Risecommerce\Blog\Model\ResourceModel\PageIdentifierGenerator::class);
    ...
    protected function _afterSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $this->_updateLinks($object, $newIds, $oldIds, 'risecommerce_blog_post_store', 'store_id');
        ...
        foreach (['category' => 'categories', 'tag' => 'tags'] as $linkType => $dataKey) {
            ...
            if (is_array($newIds)) {
                ...
                $this->_updateLinks(
                    ...
                    $newIds,
                    $oldIds,
                    'risecommerce_blog_post_' . $linkType,
                    $linkType . '_id'
                );
            }
        }
                ...
                foreach (['post', 'product'] as $linkType) {
                    if (isset($links[$linkType]) && is_array($links[$linkType])) {
                        ...
                        $this->_updateLinks(
                            ...
                            $oldIds,
                            'risecommerce_blog_post_related' . $linkType,
                            'related_id',
                            $linksData
                        );
                    }
    ...
    protected function _getLoadByIdentifierSelect($identifier, $storeIds)
    {
        $select = $this->getConnection()->select()->from(
            ...
            ['cps' => $this->getTable('risecommerce_blog_post_store')],
    ...
    {
        return $this->_lookupIds($postId, 'risecommerce_blog_post_store', 'store_id');
    }
    ...
    {
        return $this->_lookupIds($postId, 'risecommerce_blog_post_category', 'category_id');
    }
    ...
    {
        return $this->_lookupIds($postId, 'risecommerce_blog_post_tag', 'tag_id');
    }
    ...
    {
        return $this->_lookupIds($postId, 'risecommerce_blog_post_relatedpost', 'related_id');
    }
    ...
    {
        return $this->_lookupIds($postId, 'risecommerce_blog_post_relatedproduct', 'related_id');
    }
