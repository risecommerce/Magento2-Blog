...
namespace Risecommerce\Blog\Model\ResourceModel\Category;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        parent::_construct();
        $this->_init(\Risecommerce\Blog\Model\Category::class, \Risecommerce\Blog\Model\ResourceModel\Category::class);
    ...
    protected function _afterLoad()
    {
        ...
        if (count($items)) {
            ...
            $select = $connection->select()->from(['cps' => $this->getTable('risecommerce_blog_category_store')])
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                ['store_table' => $this->getTable('risecommerce_blog_category_store')],
