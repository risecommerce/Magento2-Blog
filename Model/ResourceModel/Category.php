...
class Category extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('risecommerce_blog_category', 'category_id');
    }
    ...
    protected function _beforeDelete(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $this->getConnection()->delete($this->getTable('risecommerce_blog_category_store'), $condition);
        $this->getConnection()->delete($this->getTable('risecommerce_blog_post_category'), $condition);
    ...
    protected function _afterSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $table = $this->getTable('risecommerce_blog_category_store');
    ...
    protected function _getLoadByIdentifierSelect($identifier, $storeIds)
    {
        $select = $this->getConnection()->select()->from(
            ...
            ['cps' => $this->getTable('risecommerce_blog_category_store')],
    ...
    public function lookupStoreIds($categoryId)
    {
        ...
        $select = $adapter->select()->from(
            $this->getTable('risecommerce_blog_category_store'),
            'store_id'
        )->where(
            'category_id = ?',
            (int)$categoryId
