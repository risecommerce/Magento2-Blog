...
class Tag extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('risecommerce_blog_tag', 'tag_id');
    }
    ...
    protected function _beforeDelete(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $this->getConnection()->delete($this->getTable('risecommerce_blog_post_tag'), $condition);
    ...
    protected function _afterSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $this->_updateLinks($object, $newIds, $oldIds, 'risecommerce_blog_tag_store', 'store_id');
    ...
    {
        return $this->_lookupIds($tagId, 'risecommerce_blog_tag_store', 'store_id');
    }
