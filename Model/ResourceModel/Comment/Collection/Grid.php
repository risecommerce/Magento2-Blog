...
namespace Risecommerce\Blog\Model\ResourceModel\Comment\Collection;

use Risecommerce\Blog\Model\ResourceModel\Comment\Collection;
...
class Grid extends Collection
{
    ...
    protected function _initSelect()
    {
        ...
        $this->getSelect()
            ->joinLeft(
                ['post' => $this->getTable('risecommerce_blog_post')],
