...
namespace Risecommerce\Blog\Model\ResourceModel\Tag;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        parent::_construct();
        $this->_init(\Risecommerce\Blog\Model\Tag::class, \Risecommerce\Blog\Model\ResourceModel\Tag::class);
    ...
    {
        return $this
            ->addFieldToFilter('main_table.is_active', \Risecommerce\Blog\Model\Tag::STATUS_ENABLED);
    }
    /**
    ...
    protected function _afterLoad()
    {
        ...
        if (count($items)) {
            ...
            $tableName = $this->getTable('risecommerce_blog_tag_store');
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                ['store_table' => $this->getTable('risecommerce_blog_tag_store')],
