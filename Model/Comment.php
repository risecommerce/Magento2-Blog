 ...
 * Comment model
 *
 * @method \Risecommerce\Blog\Model\ResourceModel\Comment _getResource()
 * @method \Risecommerce\Blog\Model\ResourceModel\Comment getResource()
...
class Comment extends AbstractModel implements \Magento\Framework\DataObject\IdentityInterface
{
     ...
     * @param \Risecommerce\Blog\Api\AuthorInterfaceFactory                     $userFactory,
    ...
    public function __construct(
        ...
        \Risecommerce\Blog\Api\AuthorInterfaceFactory $userFactory,
    ...
    public function getIdentities()
    {
        return [
            ...
            \Risecommerce\Blog\Model\Post::CACHE_TAG . '_' . $this->getPostId()
        ];
    }
    ...
    {
        $this->_init(\Risecommerce\Blog\Model\ResourceModel\Comment::class);
    }
    ...
    {
        return ($this->getStatus() == \Risecommerce\Blog\Model\Config\Source\CommentStatus::APPROVED);
    }
    ...
    public function getAuthor()
    {
        if (null === $this->author) {
            ...
            switch ($this->getAuthorType()) {
                case \Risecommerce\Blog\Model\Config\Source\AuthorType::GUEST:
                    $this->author->setData($guestData);
                    break;
                case \Risecommerce\Blog\Model\Config\Source\AuthorType::CUSTOMER:
                    ...
                    break;
                case \Risecommerce\Blog\Model\Config\Source\AuthorType::ADMIN:
