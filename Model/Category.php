 ...
 * Category model
 *
 * @method \Risecommerce\Blog\Model\ResourceModel\Category _getResource()
 * @method \Risecommerce\Blog\Model\ResourceModel\Category getResource()
...
class Category extends \Magento\Framework\Model\AbstractModel implements IdentityInterface
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'risecommerce_blog_category';
    ...
    {
        $this->_init(\Risecommerce\Blog\Model\ResourceModel\Category::class);
