 ...
 * Tag model
 *
 * @method \Risecommerce\Blog\Model\ResourceModel\Tag _getResource()
 * @method \Risecommerce\Blog\Model\ResourceModel\Tag getResource()
...
class Tag extends \Magento\Framework\Model\AbstractModel implements \Magento\Framework\DataObject\IdentityInterface
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'risecommerce_blog_tag';
    ...
    {
        $this->_init(\Risecommerce\Blog\Model\ResourceModel\Tag::class);
