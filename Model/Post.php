...
use Risecommerce\Blog\Api\ShortContentExtractorInterface;

/**
 * Post model
 *
 * @method \Risecommerce\Blog\Model\ResourceModel\Post _getResource()
 * @method \Risecommerce\Blog\Model\ResourceModel\Post getResource()
...
class Post extends \Magento\Framework\Model\AbstractModel implements \Magento\Framework\DataObject\IdentityInterface
{
     ...
     */
    const BASE_MEDIA_PATH = 'risecommerce_blog';
     ...
     * @var string
     */
    protected $_eventPrefix = 'risecommerce_blog_post';
    ...
    /**
     * @var \Risecommerce\Blog\Model\ResourceModel\Tag\CollectionFactory
     */
    ...
    /**
     * @var \Risecommerce\Blog\Model\ResourceModel\Comment\Collection
     */
    protected $comments;
    ...
    /**
     * @var \Risecommerce\Blog\Model\ImageFactory
     */
     ...
     * @param \Risecommerce\Blog\Model\ResourceModel\Category\CollectionFactory $categoryCollectionFactory
     * @param \Risecommerce\Blog\Model\ResourceModel\Tag\CollectionFactory $tagCollectionFactory
    ...
    public function __construct(
        ...
        Url $url,
        \Risecommerce\Blog\Model\ImageFactory $imageFactory,
        ...
        \Risecommerce\Blog\Model\ResourceModel\Tag\CollectionFactory $tagCollectionFactory,
    ...
    {
        $this->_init(\Risecommerce\Blog\Model\ResourceModel\Post::class);
    ...
    public function getIdentities()
    {
        ...
        if ($isChangedCategories) {
            ...
            foreach ($changedCategories as $categoryId) {
                $identities[] = \Risecommerce\Blog\Model\Category::CACHE_TAG . '_' . $categoryId;
            }
        }
     ...
     * @return \Risecommerce\Blog\Model\ResourceModel\Category\Collection
     */
    ...
    /**
     * Retrieve post tags
     * @return \Risecommerce\Blog\Model\ResourceModel\Tag\Collection
     */
     ...
     * @return \Risecommerce\Blog\Model\ResourceModel\Comment\Collection
     */
    ...
    public function getRelatedPosts()
    {
        if (!$this->hasData('related_posts')) {
            ...
            $collection->getSelect()->joinLeft(
                ['rl' => $this->getResource()->getTable('risecommerce_blog_post_relatedpost')],
    ...
    public function getRelatedProducts()
    {
        if (!$this->hasData('related_products')) {
            ...
            $collection->getSelect()->joinLeft(
                ['rl' => $this->getResource()->getTable('risecommerce_blog_post_relatedproduct')],
    ...
    public function getPublishDate($format = '')
    {
        ...
        return \Risecommerce\Blog\Helper\Data::getTranslatedDate(
            $format,
    ...
    public function isPublishDateEnabled()
    {
        return (bool)$this->scopeConfig->getValue(
            'rcblog/design/publication_date',
            ScopeInterface::SCOPE_STORE
        );
    }
