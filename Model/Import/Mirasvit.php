...
class Mirasvit extends AbstractImport
{
    ...
    public function execute()
    {
        ...
        foreach ($result as $data) {
            ...
            $map = [
                //mirasvit_blog ->  risecommerce_blog
                'name' => 'title',
            ...
            foreach ($map as $msField => $rcField) {
                $data[$rcField] = $this->getAttributValue('blog_category', $data['old_id'], $msField);
            }
        ...
        foreach ($result as $data) {
            ...
            $map = [
                // mirasvit ->  blog risecommerce_blog
            ...
            foreach ($map as $msField => $rcField) {
                $data[$rcField] = $this->getAttributValue('blog_post', $data['old_id'], $msField);
            }
            ...
            if ($data['featured_img']) {
                $data['featured_img'] = 'risecommerce_blog/' . $data['featured_img'];
            }
