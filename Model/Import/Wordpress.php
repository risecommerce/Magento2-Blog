...
namespace Risecommerce\Blog\Model\Import;
        ...
        foreach ($result as $data) {
            ...
            foreach ($result2 as $data2) {
                if ($data2['featured_img']) {
                    $data['featured_img'] = \Risecommerce\Blog\Model\Post::BASE_MEDIA_PATH . '/' . $data2['featured_img'];
                    break;
                }
            }
                    ...
                    if ($data2['featured_img']) {
                        ...
                        if (is_array($tmpArr)) {
                            foreach ($tmpArr as $item) {
                                ...
                                if ($item) {
                                    $data['featured_img'] = \Risecommerce\Blog\Model\Post::BASE_MEDIA_PATH . '/' . $item;
                                    break 2;
                                }
            ...
            */
            ...
            $content = preg_replace(
                ...
                'src="$4{{media url="risecommerce_blog$6$8"}}$9"',
                $content
            );
            ...
            try {
                ...
                foreach ($resultComments as $comments) {
                    ...
                    $commentData = [
                        ...
                        'status' => \Risecommerce\Blog\Model\Config\Source\CommentStatus::APPROVED,
                        'author_type' => \Risecommerce\Blog\Model\Config\Source\AuthorType::GUEST,
