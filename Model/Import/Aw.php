    ...
    public function execute()
    {
        ...
        foreach ($result as $data) {
            ...
            $data = [
                ...
                'featured_img' => !empty($data['featured_image']) ? 'risecommerce_blog/' . $data['featured_image'] : '',
            ];
            $data['identifier'] = trim(strtolower($data['identifier']));
                ...
                foreach ($resultComments as $comments) {
                    ...
                    $commentData = [
                        ...
                        'status' => ($comments['status'] == 2) ?
                            \Risecommerce\Blog\Model\Config\Source\CommentStatus::APPROVED :
                            \Risecommerce\Blog\Model\Config\Source\CommentStatus::NOT_APPROVED,
