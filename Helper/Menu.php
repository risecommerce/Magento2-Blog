...
/**
 * Risecommerce Blog Menu Helper
 * Example: {{block class="Risecommerce\Blog\Block\Smartwave\Megamenu\Topmenu" menu_type="fullwidth" }}
 */
class Menu extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getBlogNode($menu = null, $tree = null)
    {
        ...
        if ($includeCategories) {
            ...
            foreach ($items as $item) {
                ...
                $data = [
                    'name'      => $item->getTitle(),
                    'id'        => 'risecommerce-blog-category-' . $item->getId(),
     ...
     * @return \Risecommerce\Blog\Model\Category | null
     */
